...
class NerfactoModelTriDepth(Model):
    """Nerfacto model
    ...
    render_16thDepth = DepthRenderer16Percentile()
    render_84thDepth = DepthRenderer84Percentile()
    ...
    def get_outputs(self, ray_bundle: RayBundle):
        ...
        depth = self.renderer_depth(weights=weights, ray_samples=ray_samples)
        accumulation = self.renderer_accumulation(weights=weights)
        depth_16 = self.render_16thDepth(weights=weights, ray_samples=ray_samples)
        depth_84 = self.render_84thDepth(weights=weights, ray_samples=ray_samples)
