        ...
        for l2 in loss2:
            for l3 in loss3:
                for l4 in loss4:
                    arr = f"{l1} {l2} {l3} {l4}"
                    os.system(
                        f"ns-export Marching-tet --load-config {configDir} --output-dir exports/loss_ablation_{timestring}/{l1}_{l2}_{l3}_{l4}/ --use-bounding-box True --bounding-box-min -0.15 -0.2 -0.35 --bounding-box-max 0.15 0.2 0.35 --epochs 20 --batch_splits 50 --loss_weights {l1} {l2} {l3} {l4} --nerf_image_path=ssan/teststatue"
                    )
